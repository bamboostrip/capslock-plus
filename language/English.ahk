...
; lib_llmTrans.ahk
global lang_llm_name:="LLM Translation"
global lang_llm_translating:="Translating... (If the network is too bad, the translation request will temporarily block the program, just wait a moment)"
...
[TTranslate]
; Is LLM translation being used? 0 indicates using Youdao Translation, 1 indicates using Zhipu AI Translation.
useLLM=1
; Zhipu AI Translation API Key
zhipuApiKey=xxx
